...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { ano: @libro.ano, base: @libro.base, declarado: @libro.declarado, mes: @libro.mes, total: @libro.total } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { ano: @libro.ano, base: @libro.base, declarado: @libro.declarado, mes: @libro.mes, total: @libro.total } }
